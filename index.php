                      ...
                      <div class="card-body mt-0 pt-0 mx-4">
                        ...
                        <div class="col-7">
                            <h5 class="likeDisLikeFont">
                              <a href="includes/<?php if($liked == 'danger'){echo 'unlike';}else{echo 'like';}?>.inc.php?id=<?php echo $row['id']?>&p=index" class="text-<?php echo $liked;?>">
                                <span class="fas fa-heart">
                                </span>  
                              </a>
                              <?php if($result_checkLike > 0){ echo $result_checkLike;}?>
                              <!--Dislike -->
                              <a href="includes/<?php if($Disliked == 'secondary'){echo 'dislike';}else{echo 'notdislike';}?>.inc.php?id=<?php echo $row['id']?>&p=index" class="text-<?php echo $Disliked;?>">
